                    ...
                    <div class="w-full bg-gray-100 p-4 rounded-xl">
                        ...
                        <form action="{{ route('outlet.store') }}" method="post">
                            ...
                            <div class="mb-5">
                                ...
                                <input name="nama" type="text" id="nama1"
                            ...
                            <div class="mb-5">
                                ...
                                <input name="alamat" type="text" id="alamat1"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="w-full md:w-1/2 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="">
                            <label for="nama" class="block mb-2 text-sm font-medium text-gray-900">Nama Oulet</label>
...
<script>
    ...
    const outletDelete = async (id, nama) => {
        swal({
            title: "Konfirmasi",
            text: `Apakah anda yakin untuk menghapus OUTLET ${nama} ?`,
            icon: "warning",
            buttons: true,
            dangerMode: true,
