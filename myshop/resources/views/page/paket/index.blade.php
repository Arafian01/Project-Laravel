                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="">
                            ...
                            <select class="js-example-placeholder-single js-states form-control w-full m-6"
                                name="id_outlet_edit" data-placeholder="Pilih Produk" required>
                                <option value="">Pilih...</option>
                                @foreach ($outlet as $o)
                                    <option value="{{ $o->id }}">{{ $o->nama }}</option>
                                @endforeach
                        ...
                        <div class="">
                            ...
                            <input type="text" id="jenis_edit" name="jenis"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan Jenis disini..." required>
                        </div>
                        <div class="">
                            <label for="nama_paket_edit" class="block mb-2 text-sm font-medium text-gray-900">Nama
                                Paket</label>
                        ...
                        <div class="">
                            <label for="harga_edit" class="block mb-2 text-sm font-medium text-gray-900">Harga</label>
...
<script>
    ...
    const paketDelete = async (id, nama) => {
        swal({
            title: "Konfirmasi",
            text: `Apakah anda yakin untuk menghapus PAKET ${nama} ?`,
            icon: "warning",
            buttons: true,
            dangerMode: true,
